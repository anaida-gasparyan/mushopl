...
This id shopping cart system. It has a list of products available sor several categories. The products can be added to shopping cart until there is available quantity of given priduct. The list of product orders can be seen in shopping cart.
